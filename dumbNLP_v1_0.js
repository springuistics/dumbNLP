    ...
    results.forEach(function(word){
        ...
        //lemmatize words with various common endings
          ...
          const backScut1Words = ['axes','cuties','genies','movies','shoes','stereotypes','types'];
                  ...
                  const commonadjs = ['blacker', 'blanker', 'bolder', 'brasher', 'briefer', 'brighter', 'calmer', 'cheaper', 'chiller', 'cleaner', 'clearer', 'crisper', 'cleverer', 'deader', 'deeper', 'defter', 'drunker', 'duller', 'dumber', 'fainter', 'fairer', 'faster', 'firmer', 'fouler', 'franker', 'fuller', 'grander', 'greater', 'greener', 'grosser', 'harder', 'higher', 'hollower', 'iller', 'kinder', 'laxer', 'leaner', 'lesser', 'lighter', 'longer', 'louder', 'lower', 'meaner', 'moister', 'narrower', 'nearer', 'newer', 'odder', 'older','plumper', 'prouder', 'quieter', 'rasher', 'richer', 'righter', 'rounder', 'rougher', 'sharper', 'shorter', 'shyer', 'sicker', 'sleeker', 'slower', 'smaller', 'smoother', 'sourer', 'steeper', 'sterner', 'stiller', 'straighter', 'stricter', 'stronger','stupider', 'swifter', 'tenderer', 'tighter', 'warmer', 'weirder', 'wilder', 'yellower', 'younger'];
